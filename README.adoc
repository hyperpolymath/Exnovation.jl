https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/Exnovation.jl[image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF
Best Practices]]
...
A Julia framework for modeling *exnovation decisions*—phasing out legacy
practices to enable innovation.
